...
uint256 hashGenesisBlock("0xf4e9920634d4f63e4b901837f599593670fd8c33f40e9aa79168b33f2d8f42dd");
...
const string strMessageMagic = "coindiggercoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // coindiggercoin: 1 days
static const int64 nTargetSpacing = 2.5 * 60; // coindiggercoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal coindiggercoin miner
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex)
{
    ...
    if (fDebug)	
    {
    				std::string nGoldString;
    				std::string nGoldSupplyString;
    				nGoldString = nGold.ToString();
    				nGoldSupplyString = nGoldSupply.ToString();
                    printf("nGold:", nGoldString);
                    printf("nGoldSupply:", nGoldSupplyString);
	}
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "coindiggercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf4e9920634d4f63e4b901837f599593670fd8c33f40e9aa79168b33f2d8f42dd");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CoinDiggers launch their own crypto coin in 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390774893; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1390774893;
            block.nNonce   = 1331866;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x006593205ad007b35e15cef7ac40f66bc2ba14638f5f0ddf19bfd95eca1ef90e"));
